...
pub static RADIO_COMMANDS_CHANNEL: channel::Channel<CriticalSectionRawMutex, RadioCommand, 1> =
    channel::Channel::new();
    ...
    SPId: SpiDevice,
{
    pub fn new(
        ...
        Self {
            commands_receiver: RADIO_COMMANDS_CHANNEL.dyn_receiver(),
            events_sender,
            cc1101,
        }
    }
    ...
    pub fn command_sender() -> DynamicSender<'static, RadioCommand> {
        RADIO_COMMANDS_CHANNEL.dyn_sender()
    }
